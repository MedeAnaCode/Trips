...
var _toursSwiper = require("./modules/tours-swiper.js");
var _educationSwiper = require("./modules/education-swiper.js");
var _feedbacksSwiper = require("./modules/feedbacks-swiper.js");
var _advantagesSwiper = require("./modules/advantages-swiper.js");
var _gallerySwiper = require("./modules/gallery-swiper.js");
var _menu = require("./modules/menu.js");
var _videoPlay = require("./modules/video-play.js");
var _audioPlay = require("./modules/audio-play.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0, _advantagesSwiper.initWindowResize)();
...
},{"./modules/advantages-swiper.js":2,"./modules/audio-play.js":3,"./modules/education-swiper.js":4,"./modules/feedbacks-swiper.js":5,"./modules/form-validate/form.js":7,"./modules/gallery-swiper.js":13,"./modules/hero-swiper.js":14,"./modules/map.js":15,"./modules/menu.js":16,"./modules/modals/init-modals.js":17,"./modules/tours-swiper.js":19,"./modules/video-play.js":20,"./utils/ios-vh-fix.js":23}],2:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initWindowResize = exports.initAdvantagesSwiper = void 0;
var sliderAdvantages = document.querySelector('.advantages__slider');
var buttonNext = document.querySelector('.advantages__button-next');
var buttonPrev = document.querySelector('.advantages__button-prev');
var swiper5;
...
var initWindowResize = function initWindowResize() {
  window.addEventListener('resize', function () {
    return destroySwiper();
  });
};
exports.initWindowResize = initWindowResize;
...
var audioPlace = document.querySelector('[data-id="audio-place"]');
var audioButton = document.querySelector('[data-id="audio-button"]');
var onAudioButtonClick = function onAudioButtonClick() {
...
var playAudio = function playAudio() {
  return audioButton.addEventListener('click', onAudioButtonClick);
};
...
exports.initEducationSwiper = initEducationSwiper;
function initEducationSwiper() {
  var swiper3 = new Swiper('.education__slider', {
    loop: false,
    navigation: {
...
var initFeedbacksSwiper = function initFeedbacksSwiper() {
  var swiper4 = new Swiper('.feedbacks__slider', {
    loop: false,
    navigation: {
...
function initHeroSwiper() {
  var swiper1 = new Swiper('.hero-block__slider', {
    loop: true,
    pagination: {
...
var initMap = function initMap() {
  ...
  var marker = new L.Marker([55.77498793606838, 37.632662957672096], {
    icon: pin
  });
  marker.addTo(map);
};
...
var wrapper = document.querySelector('[data-id="wrapper"]');
var headerMenu = document.querySelector('[data-id="header-menu"]');
var toggleButton = document.querySelector('[data-id="toggle-menu"]');
...
var onLinkClick = function onLinkClick(evt) {
  return evt.target.tagName === 'A' ? closeMenu() : null;
};
var onScreenClick = function onScreenClick() {
  return closeMenu();
};
function openMenu() {
...
var initMenu = function initMenu() {
  toggleButton.addEventListener('click', function () {
    return toggleButton.classList.contains(openClass) ? closeMenu() : openMenu();
  });
};
...
},{"../../utils/focus-lock":21,"../../utils/scroll-lock":24}],19:[function(require,module,exports){
"use strict";
...
function initToursSwiper() {
  var swiper2 = new Swiper('.tours__slider', {
    loop: false,
    navigation: {
...
var videoPlace = document.querySelector('[data-id="video-place"]');
var videoButton = document.querySelector('[data-id="video-button"]');
...
var playVideo = function playVideo() {
  return videoButton.addEventListener('click', onVideoButtonClick);
};
